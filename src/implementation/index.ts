...
import { userAuthenticationFirebase } from 'implementation/services/userAuthenticationFirebase';
...
const getUserInteractor = new GetUserInteractor(userAuthenticationFirebase, userPresenter);
const logoutInteractor = new LogoutInteractor(userAuthenticationFirebase, userPresenter);
const loginFirebase = new LoginInteractor(userAuthenticationFirebase, userPresenter);
