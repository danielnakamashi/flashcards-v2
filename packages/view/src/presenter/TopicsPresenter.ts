...
import { IAddTopicOutput, IRemoveTopicOutput, IShowTopicsOutput } from '@flashcards/application';
import { useStore } from 'effector-react';

export interface ITopicsPresenterHook {
  useTopics(): Topic[];
  reset(): void;
}

class TopicsPresenter
  implements ITopicsPresenterHook, IAddTopicOutput, IRemoveTopicOutput, IShowTopicsOutput {
